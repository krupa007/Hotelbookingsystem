	...
	<div class="container">
		...
		<div class="col-md-8 single-gd-lt">
			...
			<div class="single-pg-hdr">
				...
				<h2><span class="glyphicon glyphicon-bed" aria-hidden="true"></span>Royal Facilities</h2>
			...
			<div class="flexslider">
							...
							<ul class="slides">
								...
								<li data-thumb="images/rf1.jpg">

									<img src="images/rf1.jpg" alt=""/>

								</li>

								<li data-thumb="images/rf2.jpg">

									<img src="images/rf2.jpg" alt=""/>

								</li>

								<li data-thumb="images/rf3.jpg">

									<img src="images/rf3.jpg" alt=""/>

								</li>

								<li data-thumb="images/rf4.jpg">

									<img src="images/rf4.jpg" alt=""/>

								</li>

								<li data-thumb="images/rf5.jpg">

									<img src="images/rf5.jpg" alt=""/>

								</li>

								<li data-thumb="images/rf6.jpg">
								...
								<li data-thumb="images/rf7.jpg">

									<img src="images/rf7.jpg" alt=""/>
