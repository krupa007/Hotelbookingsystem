	...
	<div class="container">
		...
		<div class="header-nav">
			...
			<div class="logo">
				...
				<h1><a href="index.html"><span class="glyphicon glyphicon-home" aria-hidden="true" style="color: lightblue;"></span>Blue Moon</a></h1>
	...
	<div class="container">
		...
		<div class="col-md-8 single-gd-lt">
			...
			<div class="single-pg-hdr">
				...
				<h2><span class="glyphicon glyphicon-bed" aria-hidden="true"></span>Double Room</h2>
			...
			<div class="flexslider">
							...
							<ul class="slides">
								...
								<li data-thumb="images/cc.jpg">

									<img src="images/cc.jpg" alt=""/>

								</li>

								<li data-thumb="images/dd.jpg">

									<img src="images/dd.jpg" alt=""/>

								</li>

								<li data-thumb="images/ee.jpg">

									<img src="images/ee.jpg" alt=""/>

								</li>

								<li data-thumb="images/ff.jpg">

									<img src="images/ff.jpg" alt=""/>

								</li>

								<li data-thumb="images/gg.jpg">
...
<div class="footer">
		...
		<div class="container">				 	
			...
			<div class="col-md-3 ftr-logo">
                            ...
                            <a href="index.html"><span class="glyphicon glyphicon-home" aria-hidden="true" style="color: lightblue;"></span>Blue Moon Hotel</a>
